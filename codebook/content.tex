...
\section{Graph}
\inputcode{BCC Vertex*}{2_Graph/BCC_Vertex.cpp}
%\subsection{BCC Vertex*} % test by Library Checker Biconnected Components, block-cut tree test by CF 102512 A
...
\subsection{Minimum Arborescence*} % test by luogu P4716 
\lstinputlisting{2_Graph/Minimum_Arborescence_fast.cpp}
...
\subsection{BIT kth*} % test by CSES 1076
\lstinputlisting{3_Data_Structure/BIT_kth.cpp}
...
\subsection{Heavy light Decomposition*} % test by CSES Path Queries II
...
\subsection{SAIS*} % test by CF 104901 H, Lib-Checker Suffix Array
\lstinputlisting{5_String/SAIS-C++20.cpp}
\subsection{Aho-Corasick Automatan*} % test by CF 102511 G (World Finals' problem)
...
\lstinputlisting{6_Math/floor_enumeration.cpp}
\subsection{Mod Min}
\lstinputlisting{6_Math/ModMin.cpp}
...
\subsection{Triangulation Vonoroi*} % test by CF 104555 J, NPSC 2018 territory
...
\subsection{AdaptiveSimpson*} % test by CF 101193J, 100553D
